...
public class Constant {
    ...
    public static final String EXPERTSUGGESTION = "http://www.caimiapp.com/cpzjjyu/?token=" + TOKEN + "&id=";
    ...
    public static final String SKIN_FUND_REDEMPTION_URL_GET = "http://www.caimiapp.com/api_301/buyout/getBuyoutList?token=" + TOKEN + "&cmcid=102%20HTTP/1.1";
