...
public class DetailElementBean implements Serializable{
    ...
    public static class DataBean implements Serializable{
        ...
        public String toString() {
            return "DataBean{" +
                    ...
                    ", baseTip='" + baseTip + '\'' +
                    ", elementListOrder=" + elementListOrder +
                    ", list=" + list +
                    '}';
        }
            ...
            public static class ElementListBean implements Serializable{
                ...
                public String toString() {
                    return "ElementListBean{" +
                            ...
                            ", elementChinaName='" + elementChinaName + '\'' +
                            ", pimpleCaution=" + pimpleCaution +
                            ", pregnantCaution=" + pregnantCaution +
                            '}';
                }
            }
        }
