package com.zhanghao.skinexpert.fragmenme_activity.adapter;
...
public abstract class CommonAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        SwipViewHolder holder = SwipViewHolder.get(mContext, convertView, parent,
                layoutId, position);
    ...
    public abstract void convert(SwipViewHolder holder, T t, int position, View convertView);
